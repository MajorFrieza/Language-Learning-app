 ...
 * Encapsulates lesson content with title, educational material, and paging
 * support.
 * Supports splitting lessons into multiple pages for better readability and
 * navigation.
 * 
 * Creator: Faqrulrazi
...
public class KoreanLesson {
    ...
    /**
     * The complete content of the lesson, formatted with double newlines between
     * pages.
     */
    ...
    /**
     * Get lesson pages. Page 1 is the full text; if an image exists, page 2 is the
     * image placeholder.
     * 
    ...
    /**
     * Create a comprehensive set of Korean learning lessons with multiple pages
     * each.
